...
- `2026-06-05` move-out guide deployment: production domain keeps `https://shynlimoveoutcleaning.com`; standalone move-out sitemap contains `356` unique URLs after adding `/guides` plus five practical move-out guide articles for landlord inspections, professional cleaning decisions, cost factors, timing, and photo handoff documentation.
- `npm run lint` passed
